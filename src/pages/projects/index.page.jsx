...
const seo = {
  title: 'Houssem Daas - Web Projects',
  description: 'Explore my portfolio of web projects, from responsive websites to complex web applications. Discover my work with React, Next.js, React Three Fiber, and modern web technologies.',
  keywords: [
    'Houssem Daas Projects',
