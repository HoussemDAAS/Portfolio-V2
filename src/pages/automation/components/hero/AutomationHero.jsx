...
import styles from '@src/pages/automation/components/hero/styles/automationHero.module.scss';
    ...
    <section ref={rootRef} className={clsx(styles.root, 'layout-block-inner')}>
      <header className={styles.titleContainer}>
        <h2 className={clsx(styles.title, 'h2')}>
          Automating workflows and streamlining business processes with intelligent n8n integrations and AI-powered solutions.
        </h2>
      </header>
      <div className={styles.wrapper}>
        <div ref={heroImageRef} className={styles.imageContainer}>
          <Image 
            ...
            fill 
            alt="Daas Houssem automation workflows"
            style={{
              objectFit: 'cover',
