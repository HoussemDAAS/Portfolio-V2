...
import styles from '@src/pages/education/components/hero/styles/hero.module.scss';
    ...
    <section ref={rootRef} className={clsx(styles.root, 'layout-block-inner')}>
      <header className={styles.titleContainer}>
        <h2 className={clsx(styles.title, 'h2')}>
          Building expertise through continuous learning and hands-on experience in cutting-edge technologies.
        </h2>
      </header>
      <div className={styles.wrapper}>
        <div ref={heroImageRef} className={styles.imageContainer}>
          <Image 
            ...
            fill 
            alt="Daas Houssem education journey"
            style={{
              objectFit: 'cover',
