...
function Background() {
  ...
  const uniforms = useMemo(
    () => ({
      uTime: { value: 0 },
      uColor1: { value: [26 / 255, 26 / 255, 26 / 255] },      // #1a1a1a - Deep charcoal black
      uColor2: { value: [42 / 255, 42 / 255, 42 / 255] },      // #2a2a2a - Menu dark gray
      uColor3: { value: [15 / 255, 10 / 255, 8 / 255] },       // Dark brown-black for depth
      uColorAccent: { value: new THREE.Color(1.0, 0.42, 0.21) }, // #ff6b35 - Orange accent
